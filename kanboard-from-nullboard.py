...
def handle_list(
    ...
    if maybe_col_id is not None:
        ...
        col_id = kb.add_column(project_id=proj_id, title=title)
...
def main(in_filename):
    ...
    columns = kb.get_columns(project_id=proj_id)
...
if __name__ == "__main__":
    ...
    load_dotenv()
    main("Nullboard-1661530413298-OpenXR-CTS.nbx")
