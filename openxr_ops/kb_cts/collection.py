...
class TaskCollection:
    ...
    def get_task_by_mr(self, mr_num: int) -> CTSTask | None:
    ...
    def get_task_by_issue(self, issue_num: int) -> CTSTask | None:
    ...
    def get_task_by_ref(self, short_ref: str) -> CTSTask | None:
    ...
    def get_task_by_id(self, task_id: int) -> CTSTask | None:
